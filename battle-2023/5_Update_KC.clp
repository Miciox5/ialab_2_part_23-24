...
(defrule update-kc-corazzata-hor (declare (salience 80))
...
(defrule update-kc-corazzata-ver (declare (salience 80))
...
(defrule update-kc-incrociatore-hor (declare (salience 80))
...
(defrule update-kc-incrociatore-ver (declare (salience 80)) 
   ?cell-middle <- (cell-agent (x ?x) (y ?y) (content middle) (score ?middle-s&:(neq ?middle-s -1)) )
...
(defrule update-kc-caccia-hor (declare (salience 80))
   ?cell-left <- (cell-agent (x ?x) (y ?left-y) (content left) (score ?left-s&:(neq ?left-s -1)))
...
; (status guess | fire) 
(defrule update-kc-caccia-ver (declare (salience 80))
