...
;;può eseguire una delle possibili azioni tra fire, guess, unguess e solve
(deftemplate exec
   (slot step) ;; step è un istante di tempo
...
;;supporto, tiene traccia dello stato corrente (possiamo anche usarlo)
;;usato internamente dall'ambiente
...
;;tiene traccia delle guess/fire andate a segno
